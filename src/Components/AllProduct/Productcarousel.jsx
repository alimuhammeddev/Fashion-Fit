  ...
  return (
    <section>
        ...
        <button
            ...
            className="absolute lg:-left-3 -left-9 top-1/2 transform -translate-y-1/2 rounded-full p-2 transition hover:bg-[#CAD7DF] text-white z-10 bg-[#557F99]"
          >
            <svg
          ...
          <button
            ...
            className="absolute lg:-right-3 -right-9 top-1/2 transform -translate-y-1/2 rounded-full p-2 transition bg-[#557F99] hover:bg-[#CAD7DF] text-white z-10"
          >
           <svg
            className="size-6 rtl:rotate-180"
            fill="none"
