  ...
  return (
    <section>
        ...
        <div className='mt-5 flex justify-center relative'>
            ...
            <div className="absolute top-1/2 lg:right-0 right-0 rounded-full transform -translate-y-1/2 bg-white lg:px-6 lg:py-4 px-2 py-2 flex items-center space-x-1 lg:mt-5">
